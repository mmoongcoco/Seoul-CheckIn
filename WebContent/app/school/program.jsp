                                ...
                                <div
                                    ...
                                    <!-- <button
                                        ...
                                        data-event-category="커리어고민" data-text="커리어고민"><span
                                            class="Button_Button__label__1Kk0v">커리어고민</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="517"
                                        data-event-category="HR" data-text="HR"><span
                                            class="Button_Button__label__1Kk0v">HR</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        ...
                                        data-event-category="경영·비즈니스" data-text="경영·비즈니스"><span
                                            class="Button_Button__label__1Kk0v">경영·비즈니스</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="518"
                                        data-event-category="개발" data-text="개발"><span
                                            class="Button_Button__label__1Kk0v">개발</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10244"
                                        data-event-category="회사생활" data-text="회사생활"><span
                                            class="Button_Button__label__1Kk0v">회사생활</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10241"
                                        data-event-category="취업/이직" data-text="취업/이직"><span
                                            class="Button_Button__label__1Kk0v">취업/이직</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10059"
                                        data-event-category="IT/기술" data-text="IT/기술"><span
                                            class="Button_Button__label__1Kk0v">IT/기술</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10072"
                                        data-event-category="브랜딩" data-text="브랜딩"><span
                                            class="Button_Button__label__1Kk0v">브랜딩</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="523"
                                        data-event-category="마케팅·광고" data-text="마케팅·광고"><span
                                            class="Button_Button__label__1Kk0v">마케팅·광고</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10069"
                                        data-event-category="리더십" data-text="리더십"><span
                                            class="Button_Button__label__1Kk0v">리더십</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10239"
                                        data-event-category="조직문화" data-text="조직문화"><span
                                            class="Button_Button__label__1Kk0v">조직문화</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="511"
                                        data-event-category="디자인" data-text="디자인"><span
                                            class="Button_Button__label__1Kk0v">디자인</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10214"
                                        data-event-category="노무" data-text="노무"><span
                                            class="Button_Button__label__1Kk0v">노무</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10240"
                                        data-event-category="경영/전략" data-text="경영/전략"><span
                                            class="Button_Button__label__1Kk0v">경영/전략</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10242"
                                        data-event-category="서비스기획" data-text="서비스기획"><span
                                            class="Button_Button__label__1Kk0v">서비스기획</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10238"
                                        data-event-category="라이프스타일" data-text="라이프스타일"><span
                                            class="Button_Button__label__1Kk0v">라이프스타일</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="510"
                                        data-event-category="고객서비스·리테일" data-text="고객서비스·리테일"><span
                                            class="Button_Button__label__1Kk0v">고객서비스·리테일</span></button><button
                                        class="Button_Button__root__V1ie3 Button_Button__outlined__H2mkd undefined Button_Button__sizeMedium__k0A1w InterestCategoryItem_InterestCategoryItem__yDh0r"
                                        data-attribute-id="eventList__category__update" data-event-category-id="10075"
                                        data-event-category="UX/UI" data-text="UX/UI"><span
