...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/visa/visaNav.css">
    ...
    <div class="wrap">
        <div class="entryWarp">
            <div class="img" style="padding-left: 251px; margin-top: -33px;">
                <img src="${pageContext.request.contextPath}/assets/images/visa/visaFinal.png" style="height: 390px; width: 1013px; padding-top: 42px;" alt="">
            </div>
            <div class="entryContainer">
                <div class="searchBar">
                    <div class="searchbarContainer">
                        <form id="IN_CONT"  action="">
                            <div class="searchBox" style="display: flex; justify-content: space-evenly; align-items: center;">
                                <div class="categorySelect">
                                    <div class="selectGroup">
                                            <select id="IN_CONT_CD" name="IN_CONT_CD" class="nav_search02 visa_sel">
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 24 24" class="selectIcon">
                                            <path fill="currentColor" d="M16 9.25a.75.75 0 01.586 1.218l-3.986 5a.75.75 0 01-1.17.002l-4.015-5A.75.75 0 018 9.25h8z"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div class="categorySelect">
...
<!--                                             <option value="318">BRITISH NATIONAL OVERSEAS</option>
 ...
 -->                                            <option value="315">BRITISH SUBJECT</option>
                                ...
                                <div class="categorySelect">
                                    <div class="NotificationManager_NotificationManager_wrapper__JmH6R">
                                        <button type="submit" class="NotificationManager_NotificationManager__X1DXD is-desktop" data-attribute-id="event__keywordNoti"
        ...
        <div class="navBody">
            <div class="navTable">
                ...
                <div class="navSubTitle">해당되는 체류자격을 클릭하면 비자 신청에 관한 상세정보를 볼 수 있습니다.</div>
                ...
                <div class="navResult">			
                    <table id="result1" class="resultTable">						
                        ...
                        <tbody>
                            <tr>
                                <td class="resonName">
                                    <a href="#this" name="sojQualNm" class="che_tit">
                                        <span class="nameBox">일반무사증 B-2-1</span>
                                    </a>
                                </td>
                                <td class="resonDetail">	
                                    <input type="hidden" id="SOJ_QUAL_GRP_ROW" name="SOJ_QUAL_GRP_ROW" value="B-2-1">	
                                    <input type="hidden" id="SOJ_QUAL_NM_ROW" name="SOJ_QUAL_NM_ROW" value="일반무사증">	
                                    <input type="hidden" id="MAIN_TARGET_ROW" name="MAIN_TARGET_ROW" value="관광, 방문 또는 상용 활동을 목적으로 한국을 방문하는 자는 비자를 받지 않고 입국할 수 있으며, 입국시 90일의 체류기간이 부여됩니다. <br/>※ 영리활동 또는 취업활동을 하고자 할 때에는 해당 비자를 소지하고 입국하여야 합니다.">
