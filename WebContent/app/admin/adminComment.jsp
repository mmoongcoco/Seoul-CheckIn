...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminComment.css">
                                        ...
                                        <li class="header-nav-brand">
                                            <div class="brand-holder">
                                                <a href="//llalla.imweb.me" target="_blank"
                                                    ...
                                                    <span class="text-gray">댓글 관리</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body no-padding">
                                                                <ul class="list-comments check"
                                                                    ...
                                                                    <li class="title">본문 제목</li>
                                                                    <li class="author">작성자</li>
                                                                    <li class="content">댓글 내용</li>
                                                                ...
                                                                <ul class="li_comment">
                                                                    ...
                                                                    <li class="author">왜울어</li>
                                                                    <li class="content">내일까지 해주세요</li>
