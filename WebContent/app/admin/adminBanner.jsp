...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminBanner.css">
                                        ...
                                        <li class="header-nav-brand">
                                            <div class="brand-holder">
                                                <a href="//llalla.imweb.me" target="_blank"
                                                    ...
                                                    <span class="text-gray">배너 관리</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="header-nav header-nav-options">
                                        <li class="hidden-xs">
                                            <a class="btn btn-danger"
                                                href="adminBannerAdd.html">배너 추가</a>
                                        </li>
                                        <li>
                                        ...
                                        <div class="section-body">
                                            <div class="row" id="popup_list">
                                                <div class="ma-item col-md-3 col-sm-6 col-xs-12">
                                                    <div class="card">
                                                        <div class="card-head">
                                                            <header><a href="?idx=134556&amp;mode=add"> 메인배너</a>
                                                                <span class="badge style-gray">중지</span>
                                                            </header>
                                                            <div class="tools">
                                                                <div class="btn-group">
                                                                    <div class="btn-group">
                                                                        <a href="#"
                                                                            ...
                                                                            data-toggle="dropdown">
                                                                                <img src="${pageContext.request.contextPath}/assets/images/admin/dot.png" style="width: 15px">                                                                            
                                                                            <!-- <i class="zmdi zmdi-more"></i> -->
                                                                        </a>
                                                                        <ul class="dropdown-menu animation-dock pull-right menu-card-styling"
                                                                            role="menu" style="text-align: left;">
                                                                            <li><a
                                                                                    href="?idx=134556&amp;mode=add">수정</a>
                                                                            </li>
                                                                            <li class="divider"></li>
                                                                            <li><a href="javascript:;"
                                                                                    onclick="CONFIG_POPUP.deletePopup('134556')">삭제</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <a href="?idx=134556&amp;mode=add"> <img class=""
                                                                src="https://cdn.imweb.me/upload/S202209308675dde8b5a2a/01860891e2ef0.png"
                                                                style="width:100%"></a>
                                                        <div class="card-body">
                                                            <p>
                                                                기간: 2022-10-04 14:19 ~ 2022-10-04 14:19 </p>
                                                            <p>
                                                                위치: 홈 화면 </p>
                                                        </div>
                                                    </div>
