																	...
																	<div id="kt_customers_table_wrapper"
																		...
																		<div class="row">
																			...
																			<div
																				...
																				<c:if test="${prev}">
																									<a href="${pageContext.request.contextPath}/map/adminMaplist.mp?page=${startPage - 1}">&lt;</a>
																								</c:if>
																								<c:forEach var="i" begin="${startPage}" end="${endPage}">
																									<c:choose>
																										<c:when test="${not (i eq page)}">
																											<a href="${pageContext.request.contextPath}/map/adminMaplist.mp?page=${i}">
																												<c:out value="${i}" />&nbsp;&nbsp;
																											</a>
																										</c:when>
																										<c:otherwise>
																								...
																								<c:if test="${next}">
																									<a href="${pageContext.request.contextPath}/map/adminMaplist.mp?page=${endPage + 1}">&gt;</a>
																								</c:if>
																				<!-- <div
																			...
																			<div class="modal-body py-10 px-lg-17">
																				...
																				<div class="scroll-y me-n7 pe-7"
																					...
																					<div class="fv-row mb-7 fv-plugins-icon-container">
																						<!--begin::Label-->
																						<label class="required fs-6 fw-semibold mb-2">장소명</label>
																						<!--end::Label-->
																						<!--begin::Input-->
																						<input type="text"
																...
																<div class="modal-dialog modal-dialog-centered mw-650px">
																	...
																	<div class="modal-content">
																		...
																		<form name="addEnjoyForm" method="post"
																			...
																			<!--end::Modal header-->
																			<!--begin::Modal body-->
																			<div class="modal-body py-10 px-lg-17" style="padding-bottom:30px;">
																				<!--begin::Scroll-->
																				<div class="scroll-y me-n7 pe-7"
																					id="kt_modal_add_customer_scroll"
																					data-kt-scroll="true"
...
<script>
	...
	// 관광지 등록창 열기
	$(".btn.btn-primary.addLandmark").on("click", function() {
		var $modal = $("#kt_modal_add_landmark");
		$modal.css('display', $modal.css('display') === 'none' ? 'block' : 'none');
	});
	
	// 즐길거리 등록창 열기
	$(".btn.btn-primary.addEnjoy").on("click", function() {
	...
	// map 삭제
	$("#deleteMapButton").on('click', function() {
