									...
									<li class="header-nav-brand">
										<div class="brand-holder">
											<a href="//llalla.imweb.me" target="_blank"
												...
												class="text-gray">강좌/프로그램 관리</span>
											</a>
										</div>
									</li>
								</ul>
																			...
																			<table
																				...
																				<thead>
																					...
																					<tr
																						...
																						<th class="min-w-125px sorting" tabindex="0"
																							aria-controls="kt_customers_table" rowspan="1"
																							colspan="1"
																							aria-label="Company: activate to sort column ascending">강사</th>
																						<th class="min-w-125px sorting" tabindex="0"
																							aria-controls="kt_customers_table" rowspan="1"
																							colspan="1"
																							aria-label="Payment Method: activate to sort column ascending">연락처</th>
																						<th class="min-w-125px sorting" tabindex="0"
																							aria-controls="kt_customers_table" rowspan="1"
																							colspan="1">장소</th>
																						<th>시간</th>
																				...
																				<tbody class="fw-semibold text-gray-600">
																					<c:choose>
																						...
																						<c:otherwise>
																							<tr>
																								<td colspan="15" align="center">등록된 게시물이
																									없습니다.</td>
																							</tr>
																						</c:otherwise>
																					</c:choose>
																	...
																	<div class="modal-content">
																		...
																		<form name="addProgramForm" method="post"
																			...
																			<div class="modal-header"
																				...
																				<!--begin::Modal title-->
																				<h2 class="fw-bold">Add a Program</h2>
																				<!--end::Modal title-->
																				<!--begin::Close-->
