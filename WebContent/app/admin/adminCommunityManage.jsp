																		...
																		<table style="font-size: 15px; margin: 0 auto;">
																			<tr align="center" valign="middle">
																				<td class="web-view" style="padding: 15px;"><c:if
																						test="${kPrev}">
																						<a
																							href="${pageContext.request.contextPath}/board/adminboard.bo?page=${kStartPage - 1}">&lt;</a>
																					</c:if> <c:forEach var="i" begin="${kStartPage}"
																						end="${kEndPage}">
																						<c:choose>
																							<c:when test="${not (i eq page)}">
																								<a
																									href="${pageContext.request.contextPath}/board/adminboard.bo?page=${i}">
																									<c:out value="${i}" />&nbsp;&nbsp;
																								</a>
																							</c:when>
																							<c:otherwise>
																					...
																					</c:forEach> <c:if test="${kNext}">
																						<a
																							href="${pageContext.request.contextPath}/board/adminboard.bo?page=${kEndPage + 1}">&gt;</a>
																					</c:if></td>
																			</tr>
																		</table>
																	</c:if>
