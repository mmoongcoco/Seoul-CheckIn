...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/fix/login.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/fix/join.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/fix/memberType.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/fix/password.css">
</head>
...
<body>
            ...
            <div id="margin">
                ...
                <div id="categoryandimg">
                    <button type="button" class="category">
                        <img src="${pageContext.request.contextPath}/assets/images/fix/fan(color).png" style="width:17px;height:14px;object-fit:contain">
                    </button>
                    <a id="seoul_checkinIMG" href="">
                        <img src="${pageContext.request.contextPath}/assets/images/fix/seoul-chckin(text).jpg" style="height: 14px;width: 74px;">
                    </a>
                ...
                <dir id="navigationdiv">
                    ...
                    <nav id="navigation">
                        ...
                        <ul id="ul-3">
                            ...
                            <li class="vertical" id="vertical" style="position: relative;
                        left: -145px;
                        top: -2px;">
                                <a href="" id="comservice">관리자 페이지</a>
    ...
    <div class="Modal_root__aEM8D login">
        <div class="Modal_modalContent__0zuTn style_wrapper__SO1vd border-none" style="width: 400px; overflow-y: auto;">
            <div class="ModalHeader Header_Header__0d6dF"><i class="icon-logo_new"></i><button type="button"
                    id="login_closeButton"><svg width="24" height="24" viewBox="0 0 24 24" color="#999">
            ...
            <div id="MODAL_BODY" class="ModalBody Body_body__KI0OY SignUpOrLogin_modal__VDGVH">
                ...
                <div class="InputPanel_wrapper__RXp1k"><input class="InputPanel_password__my_BO" type="password"
                        autocomplete="password">
                    <div class="style_wrapper__6RiUK InputPanel_email__aEAmZ"><label for="email"
                            class="style_label__BKYHB">이메일</label>
                        <div class="style_body__A6XnO"><input type="email" placeholder="이메일을 입력해 주세요." id="email"
                                value=""></div>
                        <div class="style_guidance__FT8Qs input-group-guidance"></div>
                    </div>
                    <div class="InputPanel_buttons__w391m"><button type="button"
                            class="style_wrapper__IgK7U email-login-button"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="InputPanel_socialWrapper__Dhaxo isKR">
                            <div class="InputPanel_socialButton__Hggw2 isKR"><button type="button"
                                    class="style_wrapper__IgK7U social-login-button kakao-login"><svg
                            ...
                            <div class="InputPanel_socialButton__Hggw2 isKR"><button type="button"
                                    class="style_wrapper__IgK7U social-login-button facebook-login"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="12" height="23" viewBox="0 0 12 23">
                            ...
                            <div class="InputPanel_socialButton__Hggw2 isKR"><button type="button"
                                    class="style_wrapper__IgK7U social-login-button google-login"><svg
                            ...
                            <div class="InputPanel_socialButton__Hggw2 isKR"><button type="button"
                                    class="style_wrapper__IgK7U social-login-button apple-login"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="19" height="24" viewBox="0 0 19 24">
                                        <path fill="#fff" fill-rule="nonzero"
                    ...
                    <p class="style_wrapper__MbwMv">걱정마세요! 여러분의 지원 활동은 SNS에 노출되지 않습니다.<br>회원가입 시 <a
                            class="loginModalAnchor" href="https://help.wanted.co.kr/hc/ko/articles/360035484292"
                            target="_blank">개인정보 처리방침</a>과 <a class="loginModalAnchor"
                            href="https://help.wanted.co.kr/hc/ko/articles/360035844551" target="_blank">이용약관</a>을
                        확인하였으며, 동의합니다.</p>
                </div>
            </div>
        </div>
        ...
        <div class="modal_box">
            <div class="modal_Header">
                <div class="welcome">
                    ...
                    <p style="font-size: 14px;">Welcome to Seoul Check-in Membership.</p>
                </div>
    ...
    <div class="Modal_root__aEM8D join">
        <div class="Modal_modalContent__0zuTn style_wrapper__SO1vd border-none" style="width: 400px; overflow-y: auto;">
            <div class="ModalHeader Header_Header__0d6dF">회원가입
            ...
            <div id="MODAL_BODY" class="ModalBody Body_body__KI0OY SetPassword_SetPassword_modal__0P9SA">
                <form id="setpassword-form" class="SetPassword_SetPassword_form__WK9NO">
                    ...
                    <div class="style_wrapper__6RiUK">
                        ...
                        <div class="style_body__A6XnO">
                            <input type="text" name="userName" placeholder="이름을 입력해 주세요." id="userName" value="">
                        </div>
                        <div class="style_guidance__FT8Qs input-group-guidance"></div>
                    </div>
                    <div class="MobileInput_MobileInput__K9xQB">
                        <div class="style_wrapper__6RiUK userPhoneNumber"><label for="userPhoneNumber"
                                class="style_label__BKYHB">휴대폰 번호</label>
                            <div class="style_body__A6XnO">
                                <div id="userPhoneNumber">
                                    <div class="MobileInput_MobileInput_select__61tfM"><span>대한민국 +82</span><select>
                                    ...
                                    <div class="MobileInput_MobileInput_input__5mhzh"><input name="userPhoneNumber"
                                            type="text" placeholder="(예시) 01034567890" value=""><button type="button"
                                            class="BtnGetCode_BtnGetCode__wR5FL isKR" disabled="">인증번호 받기</button></div>
                                    <div class="InputCode_InputCode__CvGhV"><input type="text" name="code"
                                            class="InputCode_InputCode_input__X4opi disabled"
                                            placeholder="인증번호를 입력해 주세요." disabled="" value=""></div>
                                </div>
                            </div>
                            <div class="style_guidance__FT8Qs input-group-guidance"></div>
                        </div>
                    </div>
                    <div class="style_wrapper__6RiUK"><label for="userPassword" class="style_label__BKYHB">비밀번호</label>
                        <div class="style_body__A6XnO"><input type="password" name="userPassword"
                                autocomplete="new-password" maxlength="16" placeholder="비밀번호를 입력해 주세요."
                                id="userPassword" value=""></div>
                        <div class="style_guidance__FT8Qs input-group-guidance">영문 대소문자, 숫자, 특수문자를 3가지 이상으로 조합하여 8자 이상
                            입력해 주세요.</div>
                    </div>
                    <div class="style_wrapper__6RiUK"><label for="userPasswordRepeat" class="style_label__BKYHB">비밀번호
                            확인</label>
                        <div class="style_body__A6XnO"><input type="password" name="userPasswordRepeat"
                                autocomplete="new-password" maxlength="16" placeholder="비밀번호를 다시 한번 입력해 주세요."
                                id="userPasswordRepeat" value=""></div>
                        <div class="style_guidance__FT8Qs input-group-guidance"></div>
                    </div>
                    <div class="Agreement_wrapper__1RTfh">
                        <div class="style_wrapper__TaLWc Agreement_checkboxAll__SkIo_">
                            <div class="style_check__svLur"><svg width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                            ...
                            <div class="style_label__CZv3V"><input type="checkbox" name="allAgreement">전체 동의</div>
                        </div>
                        <div class="style_wrapper__TaLWc Agreement_checkbox__OGFNT">
                            ...
                            <div class="style_label__CZv3V"><input type="checkbox" name="acceptPrivacy">개인정보 수집 및 이용
                                동의<span>(필수)</span><a href="https://help.wanted.co.kr/hc/ko/articles/360040127872"
                                    rel="noopener noreferrer" target="_blank" class="Agreement_link__qZ81b">자세히</a>
                            </div>
                        </div>
                        <div class="style_wrapper__TaLWc Agreement_checkbox__OGFNT">
                            <div class="style_check__svLur"><svg width="24" height="24" viewBox="0 0 24 24">
                            ...
                            <div class="style_label__CZv3V"><input type="checkbox" name="acceptEventEmail">이벤트 소식 등 알림
                                정보 받기<a href="https://help.wanted.co.kr/hc/ko/articles/360040540111"
                                    rel="noopener noreferrer" target="_blank" class="Agreement_link__qZ81b">자세히</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="SetPassword_SetPassword_footer_btn__UrVb_">
                    <div class="SetPassword_SetPassword_footer_btn_wrapper__SRH1U"><button type="submit"
                            class="style_wrapper__IgK7U submit is-disabled" disabled="" form="setpassword-form"
                            data-attribute-id="signup__click">회원가입하기</button></div>
                </div>
            </div>
        </div>
        <div role="presentation" class="Modal_modalOverlay__1sCXi false"></div>
