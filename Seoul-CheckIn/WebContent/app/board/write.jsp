...
<body>
    ...
    <div id="__next" data-reactroot="">
        ...
        <main class="CommunityWrite_CommunityWrite__9mT5h">
            <header class="CommunityWrite_CommunityWriteMobileHeader__zxJKy"><button type="button"
                    class="CommunityWrite_CommunityWriteMobileHeader__button__QZvT_"><i class="icon-close"></i></button>
            ...
            <form id="write">
                <div class="Header_CommunityWriteHeader__yoM82">
                    <div class="Header_CommunityWriteHeader__content__o8Uvu">
                        <div class="Header_CommunityWriteHeader__button__Js48X"><button
                                class="Button_Button__root__V1ie3 Button_Button__contained__toUI5 undefined Button_Button__sizeMedium__k0A1w Button_Button__fullWidth__RU4tf"
                                type="submit" form="write" disabled=""><span
                                    class="Button_Button__label__1Kk0v">등록하기</span></button></div>
                    </div>
                </div>
                <div class="CommunityWrite_CommunityWrite__content__t7rnC">
                    <div class="Paper_CommunityWritePaper__zgggO">
                        <div class="TagPanel_tagPanel__G236R">
                            <div class="TagPanel_tagMessage__HTFWX"><span>태그 선택</span> <span
                                    class="TagPanel_tagMessage_hint__Uio3u">(1~3개)</span> <span
                                    class="TagPanel_tagMessage_required__JhAPt">*</span></div>
                            <div class="TagPanel_tagWrapper___bVxE"><button type="button"
                                    aria-label="Open Select Tag Modal" class="plusBtn"><svg width="34" height="34" viewBox="0 0 34 34">
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#666666"></path>
                                    </svg></button><button type="button" class="TagPanel_tagPlaceholder__uBCPy"
                                    aria-label="Open Select Tag Modal">
                                    <picture>
                                        <source type="image/webp"
                                            srcset="https://static.wanted.co.kr/images/community/tag_empty.webp 1x, https://static.wanted.co.kr/images/community/tag_empty@2x.webp 2x, https://static.wanted.co.kr/images/community/tag_empty@3x.webp 3x">
                                        <img srcset="https://static.wanted.co.kr/images/community/tag_empty.png 1x, https://static.wanted.co.kr/images/community/tag_empty@2x.png 2x, https://static.wanted.co.kr/images/community/tag_empty@3x.png 3x"
                        ...
                        <div class="AutoTextarea_AutoTextarea__odSEo Paper_CommunityWritePaper__title__0zYfC">
                            <textarea class="AutoTextarea_AutoTextarea__textarea__zScTG" name="title"
                                placeholder="제목을 입력해주세요." required="" style="height: 38px;"></textarea><textarea
                                class="AutoTextarea_AutoTextarea__textarea__zScTG AutoTextarea_AutoTextarea__hidden__ScJax"
                                readonly="" style="height: 38px;"></textarea>
                        </div>
                        <div class="Paper_CommunityWritePaper__content__KM9Nk">
                            <div class="AutoTextarea_AutoTextarea__odSEo">
                                
                                <textarea class="AutoTextarea_AutoTextarea__textarea__zScTG content"  name="content" placeholder="내용을 작성해주세요." required="" style="height: 28px;overflow: auto;"></textarea>
                            ...
                            <div class="Paper_CommunityWritePaper__photos__DhsN_">
                                <button type="button" aria-label="photo remove button">
                                ...
                                <img src="banner3.jpg" alt="community-write-img" style="width:660px;">
                            </div>
            ...
            <div class="CommunityWrite_CommunityWriteMobileSubmit__nbhwO">
                ...
                <div class="CommunityWrite_CommunityWriteMobileSubmit__button__TRLXF">
                    <button
                        class="Button_Button__root__V1ie3 Button_Button__contained__toUI5 undefined Button_Button__sizeMedium__k0A1w Button_Button__fullWidth__RU4tf"
                        type="submit" form="write" disabled="">
                        <span class="Button_Button__label__1Kk0v">등록하기</span></button>
                </div>
            </div>
            <input class="CommunityWrite_CommunityPhotoFile__YOQL3" type="file" accept="image/png, image/jpeg">
            ...
            <div class="Modal_Modal__root__lNnQN undefined" style="display: none;">
                ...
                <div class="Modal_Modal__root__body__1_X6A Modal_Modal__root__body__scrollContent__ro_P_ SelectTagsModal_SelectTagsModal__5SMcy">
                    ...
                    <div class="ModalActions_ModalActions__root__8OUZk SelectTagsModal_SelectTagsModal__actions__1UVKu"><button
                            class="Button_Button__root__V1ie3 Button_Button__contained__toUI5 undefined Button_Button__sizeLarge__qMiwJ Button_Button__fullWidth__RU4tf"
                            disabled=""><span class="Button_Button__label__1Kk0v">완료</span></button></div>
                </div>
            </div>
