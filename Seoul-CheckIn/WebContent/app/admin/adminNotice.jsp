...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminNotice.css">
                                        ...
                                        <li class="header-nav-brand">
                                            <div class="brand-holder">
                                                <a href="//llalla.imweb.me" target="_blank"
                                                    ...
                                                    <span class="text-gray">공지사항</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="tab-pane" id="daily">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            <div class="card-body no-padding">
                                                                <form role="search" class="user-search" method="get"
                                                                    id="search_f" action="/admin/contents/comment/">
                                                                    <div class="form-group">
                                                                        <label for="postSearch"
                                                                            class="icon_set left _ico_search">
                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <rect opacity="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1" transform="rotate(45 17.0365 15.1223)" fill="currentColor"></rect>
                                                                                <path d="M11 19C6.55556 19 3 15.4444 3 11C3 6.55556 6.55556 3 11 3C15.4444 3 19 6.55556 19 11C19 15.4444 15.4444 19 11 19ZM11 5C7.53333 5 5 7.53333 5 11C5 14.4667 7.53333 17 11 17C14.4667 17 17 14.4667 17 11C17 7.53333 14.4667 5 11 5Z" fill="currentColor"></path>
                                                                            </svg>
                                                                        </label>
                                                                        <label class="icon_set gray right _ico_close"
                                                                            style="display:none">
                                                                            <a href="javascript:;"
                                                                                onclick="ADMIN_SEARCH.reset()"><i
                                                                                    class="zmdi zmdi-close"></i></a>
                                                                        </label>
                                                                        <div>
                                                                            <input type="text" placeholder="작성자, 내용 검색"
                                                                                value="" name="keyword"
                                                                                class="form-control typeahead _input">
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            <div class="card-head">
                                                                <header class="small">전체 댓글 <span id="comment_count"
                                                                        class="text-primary">0</span></header>
                                                                <div class="tools">
                                                                    <div id="btn_S202209308675dde8b5a2a"
                                                                        style="display: inline-block;">
                                                                        <span class="_excel_down_creat"
                                                                            style="display:inline-block;">
                                                                            <a
                                                                                href="javascript:void(0);"
                                                                                class="btn btn-default-bright btn-sm-padding"
                                                                                onclick="adminContents.openModalBoardExcelDownload('', 'comment')">
                                                                                <i
                                                                                    class="btl bt-download"></i>
                                                                                추가</a>
                                                                            <a
                                                                                href="javascript:void(0);"
                                                                                class="btn btn-default-bright btn-sm-padding"
                                                                        ...
                                                                        <span class="_excel_loading"
                                                                            style="display: none;"><a
                                                                                href="javascript:void(0)   ;"
                                                                                class="btn btn-default-bright btn-sm">다운로드
                                                                                중...</a></span>
                                                                        <span class="_excel_download"
                                                                            style="display:none;">
                                                                            <a href="javascript:void(0);"
                                                                                class="btn btn-default-bright btn-sm-padding"></a>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-body no-padding">
                                                                <ul class="list-comments check"
                                                                    ...
                                                                    <li class="title">공지 제목</li>
                                                                    <li class="content">공지 내용</li>
                                                                ...
                                                                <ul class="li_comment">
                                                                    ...
                                                                    <li class="title">회원탈퇴 관련 공지사항</li>
                                                                    <li class="content">안녕하세요. 본 사이트는 회원 탈퇴 시 차후에 복구할 수 없으니 신중을 기해주시기 바랍니다. 이용에 감사드립니다.</li>
