...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminCommunityManage.css">
                                        ...
                                        <li class="header-nav-brand">
                                            <div class="brand-holder">
                                                <a href="//llalla.imweb.me" target="_blank"
                                                    ...
                                                    <span class="text-gray">게시판 관리</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body no-padding">
                                                                <ul
                                                                    ...
                                                                    <li class="active">
                                                                        <a
                                                                            href="/admin/contents/post/?q=YToxOntzOjk6ImlkeF9vcmRlciI7czo0OiJkZXNjIjt9&amp;board_code=&amp;page_load=on">
                                                                            전체 게시물 <small id="total_list_comment_count"
                                                                                class="margin-left-lg text-bold opacity-75">0</small>
                                                                        </a>
                                                                    </li>
                                                                    <li class="" id="board_item_b202209300c8fb2668dfc0"
                                                                        ...
                                                                        <div
                                                                            class="drag _sortable_handle ui-sortable-handle">
                                                                        </div>
                                                                        <!-- <a
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body sm-padding-y">
                                                                <select class="form-control no-border">
                                                                    ...
                                                                    <option value="b202209300c8fb2668dfc0">News (0)
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="card-body no-padding">
                                                                        <div class="li_table" id="UI_TABLE">
                                                                            <ul class="subject">
                                                                                ...
                                                                                <li class="number">글 번호</li>
                                                                                <li
                                                                                    class="category hidden-xs hidden-sm">
                                                                                    카테고리</li>
                                                                                <li class="title">제목</li>
                                                                                <li class="author">작성자</li>
                                                                                <li class="date">작성일</li>
                                                                                <li class="like">좋아요 수</li>
