...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminBannerAdd.css">
                                        ...
                                        <li class="header-nav-brand">
                                            <div class="brand-holder">
                                                <a href="//llalla.imweb.me" target="_blank"
                                                    ...
                                                    <span class="text-gray">배너 추가</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="header-nav header-nav-options">
                                        <li class="hidden-xs">
                                            <a class="btn btn-danger"
                                                href="/admin/payment?mode=detail&amp;type=upgrade" style="width: 110px; text-align: center;">저장</a>
                                        </li>
                                        <li>
                                            <a class="btn btn-secondary hidden-xs" href="adminBanner.html"
                                                style="width: 115px;">취소</a>
                                                        ...
                                                        <div class="card-body">
                                                            <form id="dof" method="post" enctype="multipart/form-data"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_show_page"
                                                                                name="show_page" value="home"
                                                                                checked="checked"><span>홈 화면</span>
                                                                        </label>
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_show_page"
                                                                                name="show_page"
                                                                        ...
                                                                        <div class="row _show_page_list">
                                                                            <div class="col-sm-12">
                                                                                <div class="menu_tree alert alert-info _show_page_list_wrap"
                                                                                    style="display: none;">
                                                                                    <ul>
                                                                ...
                                                                <div class="_popup_option_wrap form-group"
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_menu_btn"
                                                                                name="menu_btn" value="Y"
                                                                                checked="checked"><span>배너 하단 버튼
                                                                                표시</span>
                                                                        </label>
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_menu_btn"
                                                                ...
                                                                <div class="_popup_option_wrap form-group"
                                                                    style="display: none;">
                                                                    <label class="col-sm-2 control-label" for="">우측 상단
                                                                        닫기 설정</label>
                                                                    <div class="col-sm-10">
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_cls_btn"
                                                                                name="cls_btn" value="close"
                                                                                checked="checked"><span>닫기</span>
                                                                        </label>
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_cls_btn"
                                                                                name="cls_btn"
                                                                                value="close_today"><span>오늘 하루 다시 보지
                                                                                않기</span>
                                                                        </label>
                                                                        <label class="radio-inline radio-styled">
                                                                            <input type="radio" class="_cls_btn"
                                                                ...
                                                                <div class="form-group _positon_center_options"
                                                                    style="display: none;">
                                                                    <label class="col-sm-2 control-label" for="">PC 팝업
                                                                        위치</label>
                                                                    <div class="col-sm-2">
                                                                        <select
                                                                            class="form-control position_horizontal_option"
                                                                            name="position_horizontal_option"
                                                                            id="position_horizontal_option">
                                                                            <option value="center">가운데</option>42<option
                                                                                value="browser_left">화면 왼쪽에서</option>58
                                                                            <option value="browser_right">화면 오른쪽에서
                                                                            </option>62<option value="body_left">본문 왼쪽에서
                                                                            </option>55<option value="body_right">본문
                                                                                오른쪽에서</option>59
                                                                        </select>
                                                                        <div class="form-control-line"></div>
                                                                    </div>
                                                                    <div class="col-sm-1" style="display: none;">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="position_horizontal" value="">
                                                                        <div class="form-control-line"></div>
                                                                    </div>
                                                                    <div class="col-sm-1" style="display: none;">
                                                                        <select class="form-control"
                                                                            name="horizontal_unit" id="horizontal_unit">
                                                                            <option value="px">px</option>31<option
                                                                                value="%">%</option>29
                                                                        </select>
                                                                        <div class="form-control-line"></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-1" style="display: none;">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="position_vertical" value="">
                                                                        <div class="form-control-line"></div>
                                                                    </div>
                                                                    <div class="col-sm-1" style="display: none;">
                                                                        <select class="form-control"
                                                                            name="vertical_unit" id="vertical_unit">
                                                                            <option value="px">px</option>31<option
                                                                                value="%">%</option>29
                                                                        </select>
                                                                        <div class="form-control-line"></div>
                                                                ...
                                                                <div class="_body_image_options">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="col-sm-2 control-label">이미지</label>
                                                                        <div class="col-sm-4">
                                                                            <div class="wrap-image-upload ">
                                                                                ...
                                                                                <div class="wrap-upload-button btn-file"
                                                                                    ...
                                                                                    <a href="javascript:;">
                                                                                        <label>
                                                                                            <input type="file" id="icon_img" style="display:none;">
                                                                                            <img src="${pageContext.request.contextPath}/assets/images/admin/no-image.JPG" id="thumbnail" style="width:300px; height:250px;">
                                                                                        </label>
                                                                                        </a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-2 control-label"
                                                                            for="img_url">이미지 링크</label>
                                                                        <div class="col-sm-5">
                                                                            <div class="input-group">
                                                                                <div class="input-group-content">
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="link_url" id="img_url"
                                                                                        value="http://">
                                                                                    <div class="form-control-line">
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="_popup_option_wrap"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-sm-2 control-label">너비</label>
                                                                            <div class="col-sm-2 width-3">
                                                                                <div class="input-group-content">
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="img_width" id="img_width"
                                                                                        value="320">
                                                                                    <div class="form-control-line">
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="form-group on_mobile"
                                                                            style="display: none;">
                                                                            <label class="col-sm-2 control-label">모바일 배너
                                                                                너비</label>
                                                                            <div class="col-sm-2 width-3">
                                                                                <div class="input-group-content">
                                                                                    <input type="text"
