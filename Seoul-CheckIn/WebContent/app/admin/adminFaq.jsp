                                                        ...
                                                        <div class="card">
                                                                    ...
                                                                    <div id="btn_S202209308675dde8b5a2a"
                                                                        ...
                                                                        <span class="_excel_down_creat"
                                                                            ...
                                                                            <a
                                                                                ...
                                                                                onclick="adminContents.openModalBoardExcelDownload('', 'comment')"><i
                                                            ...
                                                            <div class="card-body no-padding">
                                                                <ul class="list-comments check"
                                                                    ...
                                                                    <li class="title">이용 질문</li>
                                                                    <li class="content">답변</li>
                                                                ...
                                                                <ul class="li_comment">
                                                                    ...
                                                                    <li class="title">내국인 서비스 가입, 이용 절차가 궁금합니다</li>
                                                                    <li class="content">가입절차를 확인하시려면</li>
